...
export const metadata: Metadata = { title: "Projects | Dr. Henry Jones", description: "Programs and missions in ocean and atmospheric science, operational meteorology, environmental safety, defense, and federal service." };

export default function ProjectsPage() {
  return (
    <main className="page-shell">
      <PageIntro eyebrow="Projects" index="03 / 05" title="Programs and missions." />
