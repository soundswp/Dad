...
export default function ContactPage() {
  return (
    <main className="page-shell">
      ...
      <section className="contact-section contact-page"><div className="contact-intro"><p className="eyebrow"><span aria-hidden="true" /> Consulting inquiries</p><h2>Start with a brief description.</h2><p>Include the organization, the technical or program question, and the type of support you are considering.</p><div className="direct-contact"><span>DIRECT CONTACT</span><a href="mailto:hjusn@yahoo.com">hjusn@yahoo.com</a><LinkedInLink /></div></div><ContactForm /></section>
    </main>
  );
}
